...
<template>
  <div class="app-container">
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @sort-change="sortChange"
      ...
      <el-table-column prop="商家名称" label="商家名称" align="left" header-align="center"    width="200"/>
      <el-table-column prop="收件人信息" label="发件人信息" align="left" header-align="center"  :show-overflow-tooltip="true" />
      <el-table-column prop="群名称" label="群名称" align="left" header-align="center"    width="250"  />
